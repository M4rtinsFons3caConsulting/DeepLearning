...
Images are shown to a user, and their choices are incrementally saved to a CSV file,
allows for resuming from the last line treated.

Usage:
    python label_binary.py --output labels
"""
